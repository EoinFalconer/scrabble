                                                ...
                                                <div class="panel-body"> 
                                                    <div class="alert alert-success">
                                                        <form action="add_tag.php" method="POST">
                                                            <strong>Tag Name:</stronge> 
                                                             <input class="form-control" placeholder="Category Sub-Category" name="tag_name">
                                                            
                                                                   
                                                                </div>
                                                            <button type="submit" value="add tag" name="add_tag" class="btn btn-default">Add Tag</button>
                                                        </form>
