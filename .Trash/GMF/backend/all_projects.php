                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                     ...
                                     <tbody>
                                        <?php
                                           $projects = mysqli_query($con, "SELECT * FROM Projects ORDER BY project_id DESC");
                                           while ($project = mysqli_fetch_array($projects)) { 
                                               
                                                echo "<tr class='odd gradeX'>";
                                                echo  "<td>". $project['project_client']. "</td>";
                                                echo  "<td>". get_category_name($project['project_category']). "</td>";
                                                echo  "<td>". nl2br($project['project_description']). "</td>";
                                                echo  "<td><img style='width:200px; height:200px;' src='". $project['image_url']. "' /></td>";
                                                echo  "<td class='center'>". $project['project_date']. "</td>";
                                                echo  
                                                "<td>
                                                    <form  action='all_projects.php' method='POST'>
                                                        <button type='submit' value='". $project['project_id']."' name='remove_project' class='btn btn-danger'>Delete</button>
                                                    </form>
                                                </td>";
                                                echo  
                                                "<td>
                                                    <a href='edit_project.php?id=" . $project['project_id']. "' class='btn btn-info'>Edit</a>
                                                </td>";
                                                echo  "</tr>";
                                            }
                                       ...
                                       <?php 
                                            if ($row['superuser'] != 0) {
                                                if(isset($_POST['remove_project'])) {
                                                            if (mysqli_query($con, "DELETE FROM Projects WHERE id= '".$_POST['remove_project']."'")) {
                                                ...
                                                if(isset($_POST['remove_project'])) {
                                                            echo "You have insufficint permissions to delete an project." ;
                                                        }
