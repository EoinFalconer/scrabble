                                         ...
                                         while ($admin_user = mysqli_fetch_array($result)) { 
                                                ...
                                                if($admin_user['superuser'] != 0) {
                                                    ...
                                                    ?>
                                                        ...
                                                        Edit <?php echo $admin_user['first_name'] . " " . $admin_user['surname'];?> :
                                                    </div>        
                                                                ...
                                                                <div class="panel-body"> 
                                                                    ...
                                                                    <p>
                                                                        Please note if you edit yourself from this page you will be logged out, and be required to log back in 
                                                                    </p>
                                                                    ...
                                                                    <div class="alert alert-success">
                                                                        <form action=<?php echo "'". $action_url."'";?>  method="POST">
                                                                            ...
                                                                            <strong>Select Role: </strong> <?php echo $admin_user['role'];?>
                                                                            ...
                                                                            <strong>Superuser: </strong><?php echo $superuser;?>
                                                                            ...
                                                                            <button type="submit" value="edit_admin" name="edit_admin" class="btn btn-default">Edit Admin</button>
                                                                        </form>
                                                                        ...
                                                                        if(isset($_POST['edit_admin'])) {
                                                                                ...
                                                                                $superuser_new = $admin_user['superuser'];
                                                                                if ($_POST['superuser'] != "na") {
                                                                                    $superuser_new = $_POST['superuser'];
                                                                                ...
                                                                                echo $email . " " . $role . " " . $surname . " " . $first_name . " " . $superuser_new;

                                                                                $sql = "UPDATE admin_users SET first_name = '$first_name', surname = '$surname', email= '$email', role = '$role', superuser = '$superuser_new' WHERE id= '$the_id' ";
