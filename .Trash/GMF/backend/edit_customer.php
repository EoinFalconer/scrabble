                          ...
                          <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                     <?php  
                                         $the_id = $_GET['id'];
                                         $action_url = "edit_customer.php?id=".$the_id;
                                         $result = mysqli_query($con, "SELECT * FROM Customer_List WHERE cust_id = $the_id");
                                         while ($Customer_List = mysqli_fetch_array($result)) { 

                                                ?>
                    
                                                        Edit <?php echo $Customer_List['cust_name']?> :
                                                    </div>        

                                                                <div class="panel-body"> 
                                                                    <p> Please only enter information for the fields you'd like to edit, empty fields will
                                                                    mean that the customers information will remain the same.
                                                                    </p>
                                                                    ...
                                                                    <div class="alert alert-success">
                                                                        <form action=<?php echo "'". $action_url."'";?>  method="POST">
                                                                            <strong>Name: </strong> <?php echo $Customer_List['cust_name'];?> 
                                                                             <input class="form-control" placeholder="Joe" name="name">
                                                                        
                                                                             <strong>Email: </strong>  <?php echo $Customer_List['cust_email'];?>
                                                                             <input class="form-control" placeholder="Joe@Blogs.ie" name="email">
                                                                             
                                                                            <strong>Select Section: </strong> <?php echo get_category_name($Customer_List['cust_section']);?>
                                                                            ...
                                                                            <button type="submit" value="edit_customer" name="edit_customer" class="btn btn-default">Edit Customer</button>
                                                                        </form>
                                                                        ...
                                                                        if(isset($_POST['edit_customer'])) {
                                                                                ...
                                                                                $name = $Customer_List['cust_name'];
                                                                                if ($_POST['name'] != "") {
                                                                                    $name = $_POST['name'];
                                                                                    
                                                                                }

                                                                                $email = $Customer_List['cust_email'];
                                                                                if ($_POST['email'] != "") {
                                                                                    $email = $_POST['email'];
                                                                                }

                                                                                $section = $Customer_List['cust_section'];
                                                                                if ($_POST['section'] != "na") {
                                                                                 ...
                                                                                 $sql = "UPDATE Customer_List SET cust_name = '$name', cust_email = '$email', cust_section = '$section' WHERE cust_id= '$the_id' ";

                                                                                if(mysqli_query($con, $sql)) {
                                                                                    echo " Customer successfully Edited";
                                                                                  }
                                                                                else {
                                                                                    echo "Error Occured";
                                                                                }
