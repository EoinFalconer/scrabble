    ...
    <div id="wrapper">
       ...
       <?php include('nav_side.php');?>
        ...
        <?php 
             ...
             $getuser = mysqli_query($con, "SELECT * FROM admin_users WHERE email = '".$email."' AND first_name = '".$firstname."'");
                                        ...
                                        User Info:
                                                ...
                                                <div class="panel-body"> 
                                                    <div class="alert alert-success">
                                                        <strong>Name:</strong> <?php echo " " . $row['first_name'] . " " . $row['surname']; ?>
                                                    </div>
                                                   <div class="alert alert-success">
                                                    ...
                                                    <?php echo "<a href='change_info.php?id=" . $row['id']. "' class='btn btn-default'>Change Information</a>";?>
                                                </div>
                               </div>
                         </div>  
