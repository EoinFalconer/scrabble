                                     ...
                                     <tbody>
                                        <?php
                                           ...
                                           while ($category = mysqli_fetch_array($categories)) { 
                                                ...
                                                echo  "<td> <img style='width:200px; height:200px;' src='". $category['category_image']. "'/></td>";
                                                echo  "<td class='center'>". $category['admin_user']. "</td>";
                                                echo  
                                                "<td>
                                                    <a href='edit_category.php?id=" . $category['category_id']. "' class='btn btn-info'>Edit</a>
                                                </td>";
                                                echo  "</tr>";
                                            }
