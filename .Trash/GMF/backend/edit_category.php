                          ...
                          <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                     <?php  
                                         $the_id = $_GET['id'] ;
                                         $action_url = "edit_category.php?id=".$the_id;
                                         $result = mysqli_query($con, "SELECT * FROM Categories where category_id = $the_id");
                                         while ($category = mysqli_fetch_array($result)) { 

                                                    ?>
                    
                                                        Edit <?php echo $category['category_name'];?> :
                                                    </div>        

                                                                <div class="panel-body"> 
                                                                    <p> Please only enter information for the fields you'd like to edit, empty fields will
                                                                    mean that the category information will remain the same.
                                                                    </p>
                                                                    ...
                                                                    <div class="alert alert-success">
                                                                        <form action=<?php echo "'". $action_url."'";?>  method="POST" enctype="multipart/form-data">
                                                                            <strong>Category Name: </strong> <?php echo $category['category_name'];?> 
                                                                             <input class="form-control" placeholder="Primary" name="cat_name">
                                                                          
                                                                      <div class="form-group">
                                                                            <br />
                                                                            <?php echo "<img src='" .$category['category_image'] . "'' style='width:400px; height:400px;' alt=''>"; ?>
                                                                    ...
                                                                    if(isset($_POST) and $_SERVER['REQUEST_METHOD'] == "POST"){
                                                                        ...
                                                                        foreach ($_FILES['files']['name'] as $f => $name) {     
                                                                            if($name != "") {  
                                                                                    ...
                                                                                    if ($_FILES['files']['error'][$f] == 0) {              
                                                                                        ...
                                                                                        elseif( ! in_array(pathinfo($name, PATHINFO_EXTENSION), $valid_formats) ){
                                                                                            ...
                                                                                            continue; // Skip invalid file formats
                                                                                                    ...
                                                                                                    $sql =  "UPDATE Categories SET category_name = '$category_name', category_image = '$image_url' WHERE category_id= '$the_id' ";
                                                                                                    if (mysqli_query($con, $sql)) {
                                                                                                            echo "categorys item edited";
                                                                                                     } else {
                                                                                                        echo "problem";
                                                                                                    }
                                                                                                }
                                                                                ...
                                                                                $image_url = "";
                                                                                 $sql =  "UPDATE Categories SET category_name = '$category_name' WHERE category_id = '$the_id' ";
