                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                     ...
                                     <tbody>
                                        <?php
                                           $categories = mysqli_query($con, "SELECT * FROM  Sub_Categories");
                                           while ($category = mysqli_fetch_array($categories)) { 
                                                echo "<tr class='odd gradeX'>";
                                                echo  "<td>". $category['sub_name']. "</td>";
                                                echo  "<td class='center'>". $category['sub_description']. "</td>";
                                                echo  
                                                "<td>
                                                 <a href='edit_subcategorie.php?id=" . $category['sub_cat_id']. "' class='btn btn-info'>Edit</a>
                                                  </td>";
                                                echo  "</tr>";
                                            }
