                                                ...
                                                <div class="panel-body"> 
                                                    <div class="alert alert-success">
                                                       <form action="add_sub_cat.php" method="post" enctype="multipart/form-data">
                                                            <strong>Sub Category Name </stronge> 
                                                            <select id="name" name="sub_name" class="form-control" >
                                                                <option value="na">Select Section: </option> 
                                                                <option value="Chairs">Chairs</option> 
                                                                <option value="Postura">Postura</option> 
                                                                <option value="Tables/Desking">Tables/Desking</option> 
                                                                ...
                                                                <option value="Science Storage">Science Storage</option>
                                                                <option value="Tired Seating">Tired Seating</option> 
                                                                <option value="Laptop/iPad Storage">Laptop/iPad Storage</option>  
                                                            </select>

                                                             <strong>Sub Category Description:</stronge> 
                                                            <input class="form-control" placeholder="Product Description" name="description">
                                                            ...
                                                            <input type="submit" value="Add Sub Category" name="add_sub_cat">
                                                        </form>
                                                                                ...
                                                                                if ($_FILES['files']['error'][$f] == 0) {              
                                                                                    ...
                                                                                    elseif( ! in_array(pathinfo($name, PATHINFO_EXTENSION), $valid_formats) ){
                                                                                        ...
                                                                                        $brochure =  $path.$name;
                                                                                         ...
                                                                                         $sql =  "INSERT INTO Sub_Categories(sub_name, sub_description, brochure) 
                                                                                            VALUES ('$sub_name', '$sub_description', '$brochure')";
                                                                            
                                                                                                if (mysqli_query($con, $sql)) {
                                                                                                        echo "Sub Category added";
                                                                                                } else {
                                                                                                    echo "Problem adding Sub Category";
                                                                                                }
                                                                                    }
