                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                     ...
                                     <tbody>
                                        <?php
                                           $customers = mysqli_query($con, "SELECT * FROM Customer_List ORDER BY date DESC");
                                           while ($cust = mysqli_fetch_array($customers)) { 
                                               
                                                echo "<tr class='odd gradeX'>";
                                                echo  "<td>". $cust['cust_name']. "</td>";
                                                echo  "<td>". $cust['cust_email']. "</td>";
                                                echo  "<td>". get_category_name($cust['cust_section']). "</td>";
                                                echo  "<td class='center'>". $cust['date']. "</td>";
                                                echo  
                                                "<td>
                                                    <form  action='all_customers.php' method='POST'>
                                                        <button type='submit' value='". $cust['cust_id']."' name='remove_cust' class='btn btn-danger'>Delete</button>
                                                    </form>
                                                </td>";
                                                echo  
                                                "<td>
                                                    <a href='edit_customer.php?id=" . $cust['cust_id']. "' class='btn btn-info'>Edit</a>
                                                </td>";
                                                echo  "</tr>";
                                            }
                                       ...
                                       <?php 
                                            if ($row['superuser'] != 0) {
                                                if(isset($_POST['remove_cust'])) {
                                                            if (mysqli_query($con, "DELETE FROM Customer_List WHERE cust_id= '".$_POST['remove_cust']."'")) {
                                                ...
                                                if(isset($_POST['remove_cust'])) {
                                                            echo "You have insufficint permissions to delete a customer." ;
                                                        }
