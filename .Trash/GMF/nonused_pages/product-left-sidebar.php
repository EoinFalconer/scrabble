...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
  <head>
    ...
    <title>Rosette | Responsive Multipurpose HTML5 Template | Product page</title>
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="header_top_cc_left">
						<ul>
							<li><a href="tel:84888868"><i class="fa fa-phone"></i>Call + 84 888 868</a></li>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="header_top_cc_right">
						<ul>
							...
							<li class="active"><a href=""><img alt="" src="images/america.png">English<i class="fa fa-angle-down"></i></a>
								<div class="language_dropdown">
									<ul>
										<li class="first_child"><a href="">
											<span class="flag_two"><img src="images/america.png" alt="" /></span>English</a>
										</li>
										<li><a href="">
											<span class="flag_two"><img src="images/french.png" alt="" /></span>French</a>
										</li>
										<li><a href="">
											<span class="flag_two"><img src="images/german.png" alt="" /></span>German</a>
										</li>
									</ul>
								</div>
							</li>
							...
							<li class="active"><a href="">USD <i class="fa fa-angle-down"></i></a>
								<div class="currency_dropdown">
									<ul>
										<li class="first_child"><a href="">EUR - Euro</a></li>
					...
					<div class="header_middle_right">
						<nav class="mainmenu">
							<ul>
								...
								<li><a href="shop-right-sidebar.html">Men</a></li>
								<li><a href="shop-right-sidebar.html">Accessories</a></li>
									...
									<div class="row">
										...
										<div class="col-md-7 col-sm-12 col-xs-7">
											<div class="featured_info">
												<a href="product-left-sidebar.html">Sample product</a>
												<div class="rating">
													<ul>
									...
									<div class="row">
										<div class="col-md-5 col-sm-12 col-xs-5">
											...
											<div class="image_weekly_change">
												<div class="single_weekly_img">
													<div class="weekly_overlay"></div>
													<img src="images/1012630_45.jpg" alt="" />
												</div>
												<div class="single_weekly_img_hover">
													<div class="weekly_overlay"></div>
													<img src="images/1012628_25.jpg" alt="" />
												</div>
											</div>
											<!-- Modal Start -->
									...
									<div class="row">
										<div class="col-md-5 col-sm-12 col-xs-5">
											...
											<div class="image_weekly_change">
												<div class="single_weekly_img">
													<div class="weekly_overlay"></div>
													<img src="images/8501304098_1_1_1.jpg" alt="" />
												</div>
												<div class="single_weekly_img_hover">
													<div class="weekly_overlay"></div>
													<img src="images/front_marketbag_1.jpg" alt="" />
												</div>
											</div>
											<!-- Modal Start -->
							  ...
							  <div class="carousel-inner" role="listbox">
									...
									<div class="sidebar_banner">
										<div class="banner-top">
											<div class="banner-inner-content">
												<img src="images/banner-sidebar-1.jpg" alt="" />
								...
								<div class="item">
								  <div class="sidebar_banner">
										<div class="banner-top">
											<div class="banner-inner-content">
												<img src="images/banner-sidebar-2.jpg" alt="" />
												<div class="overlay"></div>
						...
						<div class="row">
							<div class="col-md-7 col-sm-7 col-xs-12">
								<div class="single_product_image">
									...
									<ul id='zoom1' class=''>
										<li>
											<img src="images/1014256_front.jpg" alt='image1' />
										</li>
										<li>
											<img src="images/1014254_front.jpg" alt='image2' />
										</li>
										<li>
											<img src="images/1014254_side.jpg" alt='image3' />
										</li>
										<li>
											<img src="images/1014254_full2.jpg" alt='image1' />
										</li>
										<li>
											<img src="images/1014254_closeup.jpg" alt='image2' />
										</li>
										<li>
											<img src="images/1014254_back.jpg" alt='image2' />
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="latest_product">
									<div id="latest-product-caro">
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc1"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
												<div class="featured_info">
													<a href="product-left-sidebar.html">Sunglasses</a>
													<div class="rating">
														<ul>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc2"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
												<div class="featured_info">
													<a href="product-left-sidebar.html">Hats</a>
													<div class="rating">
														<ul>
															<li><a class="fa fa-star" href=""></a></li>
															<li><a class="fa fa-star" href=""></a></li>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc3"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
												<div class="featured_info">
													<a href="product-left-sidebar.html">Women Shirt</a>
													<div class="rating">
														<ul>
															<li><a class="fa fa-star" href=""></a></li>
															<li><a class="fa fa-star" href=""></a></li>
									  ...
									  <div class="item">
											...
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc4"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
												<div class="featured_info">
													<a href="product-left-sidebar.html">Shoe</a>
													<div class="rating">
														<ul>
															<li><a class="fa fa-star" href=""></a></li>
															<li><a class="fa fa-star" href=""></a></li>
										...
										<div class="item">
											<div class="single_featured_product">
												<div class="image_feature_change">
													...
													<div class="single_feature_img_hover">
														<div class="image-overlay"></div>
														<img src="images/feature8.jpg" alt="" />
													</div>
												</div>
												<div class="heart-icon">
													<a class="fa fa-heart" href=""></a> 
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc5"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												<div class="image_feature_change">
													...
													<div class="single_feature_img_hover">
														<div class="image-overlay"></div>
														<img src="images/feature12.jpg" alt="" />
													</div>
												</div>
												<div class="heart-icon">
													<a class="fa fa-heart" href=""></a> 
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc6"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
												<div class="featured_info">
													<a href="product-left-sidebar.html">Women jacket</a>
													<div class="rating">
														<ul>
															<li><a class="fa fa-star" href=""></a></li>
															<li><a class="fa fa-star" href=""></a></li>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc7"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc8"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
												<div class="featured_info">
													<a href="product-left-sidebar.html">Women T-Shirt</a>
													<div class="rating">
														<ul>
															<li><a class="fa fa-star" href=""></a></li>
															<li><a class="fa fa-star" href=""></a></li>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc9"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc10"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc11"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
												<div class="featured_info">
													<a href="product-left-sidebar.html">Women wear</a>
													<div class="rating">
														<ul>
															<li><a class="fa fa-star" href=""></a></li>
															<li><a class="fa fa-star" href=""></a></li>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc12"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
												<div class="featured_info">
													<a href="product-left-sidebar.html">Man Shirt</a>
													<div class="rating">
														<ul>
															<li><a class="fa fa-star" href=""></a></li>
															<li><a class="fa fa-star" href=""></a></li>
									  ...
									  <div class="item">
											<div class="single_featured_product">
												...
												<div class="search-icon">
													<a class="fa fa-search" href="" data-toggle="modal" data-target="#productleftcc13"></a> 
												</div>
												<div class="cart-icon">
													<a class="fa fa-shopping-cart" href=""></a> 
												</div>
									...
									<!-- Modal Start -->
									<div id="productleftcc1" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc2" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc3" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc4" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc5" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc6" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc7" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc8" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc9" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc10" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc11" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc12" class="modal fade" role="dialog">
									  <div class="modal-dialog">
									...
									<!-- Modal END -->
									<!-- Modal Start -->
									<div id="productleftcc13" class="modal fade" role="dialog">
									  <div class="modal-dialog">
							...
							<div class="col-md-3 col-sm-3 col-xs-12">
								<div class="footer_wid">
									...
									<div class="first_wid_text">
										<p>Suspendisse metus diam, pulvinar nec mas sa non, dignis sim imperdiet nulla. Suspen disse malesuada diam id ante mole.</p>
									</div>
									<h3>find us on</h3>
							...
							<div class="col-md-2 col-sm-2 col-xs-12">
								<div class="footer_wid">
									...
									<nav class="footer_wid_menu">
										<ul>
											<li><a href=""><i class="fa fa-caret-right"></i>View Cart</a></li>
											<li><a href=""><i class="fa fa-caret-right"></i>My Wishlist</a></li>
											<li><a href=""><i class="fa fa-caret-right"></i>Check out</a></li>
								...
								<div class="footer_wid">
									...
									<div class="footer_payment">
										<ul>
											...
											<li><a href="#"><img src="images/mc.png" alt="visa" /></a></li>
											<li><a href="#"><img src="images/discover.png" alt="visa" /></a></li>
											<li><a href="#"><img src="images/AE.png" alt="visa" /></a></li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="col-md-7 col-sm-8 col-xs-12">
					<nav class="footer_bottom_left">
						<ul>
							...
							<li class="last_child"><a href="">Contact Us</a></li>
						</ul>
					</nav>
				</div>
