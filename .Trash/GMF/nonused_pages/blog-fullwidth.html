...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
  ...
  <body class="blog_fullwidth">
	...
	<!--==| main blog start |==-->
	<div class="blog_fullwidth_area main_blog_area">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="cc_blog_fullwidth main_blog">
								...
								<div class="row">
									...
									<div class="col-md-10 col-sm-10 col-xs-7">
										<div class="b_t_right">
											...
											<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and been the industry’s scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into […]</p>
										</div>
									</div>
								</div>
							</div>
