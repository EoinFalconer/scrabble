...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
  <head>
    ...
    <title>Rosette | Responsive Multipurpose HTML5 Template | Order completed page</title>
  ...
  <body class="blog_fullwidth">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<h1 class="bread-title">Order completed</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<!--==|order top menu start |==-->
	<div class="cc_main_checkout_area">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="main_checkout main_cart">
						<div class="top_check_menu top_cart_menu">
							<ul>
								<li><a href="cart.html">
									<span>1</span>
									<p>Shopping Cart</p>
	...
	<!--==| main order area start |==-->
	<section class="order_complete_area">
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="order_complete_cc">
						<p>Your order os completed.Thanks for your Shopping with us.</p>
					</div>
				</div>
			</div>
		</div>
    ...
    <!--==| Home Service start |==-->
	<section class="home_service_area">
		<div class="container">
			<div class="row">
